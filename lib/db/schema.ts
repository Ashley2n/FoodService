...
//dish_ingredients
export const dish_ingredients = pgTable(
  "dish_ingredients",
  {
  ...
  (dish_ingredients) => [
    primaryKey({
      columns: [dish_ingredients.dishId, dish_ingredients.ingredientId],
    }),
  ]
);
...
export const ingredients = pgTable("ingredients", {
  ...
  is_optional: boolean("is_optional").notNull(),
  is_allogenic: boolean("is_allogenic").notNull(),
  createdAt: timestamp("created_at").notNull().defaultNow(),
  updatedAt: timestamp("updated_at").defaultNow(),
});
